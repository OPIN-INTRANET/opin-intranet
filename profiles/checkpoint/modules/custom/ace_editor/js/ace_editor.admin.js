(function($) {
  ...
  Drupal.behaviors.ace_editor_admin = {
	attach: function(context, settings) {
		...
		*/
		$('div.text-format-wrapper fieldset.filter-wrapper select.filter-list').on('change', function(e) {
		 ...
		 */
		$('div.text-format-wrapper div.control input, div.text-format-wrapper div.control select').on('change', function(e) {
		 ...
		 */
		$('a.link-edit-summary').on('mouseup', function(e) {
			var $link = $(this);
